...
def FindMinimum(func: Callable[[List[float]], float], gradient: Callable[[List[float]], List[float]], reverseMatrix: Callable[[List[float]], List[List[float]]], startPoint: List[float], e: float) -> List[Tuple[List[float], float]]:
